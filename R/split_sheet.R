...
#'   split on).
#' @param keep A logical vector of length one indicating whether to keep all data frames (if TRUE)
#'   or discard data frames for groups where there are no observations (if FALSE), particularly if
#'   more than one variable is specified for splitting.
#'
