...
![Graphic of headhoncho package workflow](man/figures/README-workflow_graphic.jpg)
...
The `login_function` can be used to read in data from a URL. It will also check for read and write authentication for a Google account.
