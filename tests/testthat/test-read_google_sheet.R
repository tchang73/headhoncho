...
test_that(
  "The correct message and value are returned when there's an error in read_google_sheet().",
  {
...
test_that("read_google_sheet() returns an object with the correct structure",
          {
            # Indicating to the Google sheets 4 api that we don't need authorization (using public
            # sheet)
            gs4_deauth()
            # Output should be of type "list"
            expect_type(read_google_sheet("1HO3e_VCqdbyRGbKOgzt57aLLlhVCP7YQGmy411tqGNc"),
                        "list")
            ...
            # Output should have dimensions [599, 9]. This is what the actual google sheet's
            # dimensions are.
            expect_equal(dim(
              read_google_sheet("1HO3e_VCqdbyRGbKOgzt57aLLlhVCP7YQGmy411tqGNc")
            ),
